...
book_b = Book.create(title:'Fahrenhiet', author: author_b, genre: genre_c)
book_c = Book.create(title:"The Hitchhiker's Guide to the Galaxy", author: author_a, genre: genre_c)